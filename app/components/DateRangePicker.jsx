...
export function DateRangePicker({ dateChangeCallback = (dateOrDateRange) => {} }) {
  ...
  function handleMonthChange(month, year) {
    console.log("month change", month, year);
    setDate({ month, year });
  }
  function handleCalendarChange({ start, end }) {
    console.log("calendar change", start, end);
  ...
  function apply() {
    setPopoverActive(false);
    dateChangeCallback(activeDateRange.period);
  }
  function cancel() {
    setPopoverActive(false);
  }
